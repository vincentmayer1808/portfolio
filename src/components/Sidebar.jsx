...
const Sidenavbar = () => {
  ...
  >
    ...
    <Sidebar id="logo-sidebar" aria-label="Navegation Sidebar"  className=" bg-sky-950 fixed z-40 left-0 w-64 border-r-4 border-fuchsia-600 h-screen text-cyan-300 transition-transform -translate-x-full sm:translate-x-0 ">
      <Sidebar.Logo
        href="/"
        className=" bg-sky-950 border-b-4 border-fuchsia-600  text-cyan-300"
      >
        <p className="hover:text-fuchsia-600">Vincent Mayer</p>
      </Sidebar.Logo>
      <Sidebar.Items>
        <Sidebar.ItemGroup className="bg-sky-950 text-cyan-300">
          ...
          <Sidebar.Item className="hover:bg-fuchsia-600" icon={HiUser} href="/presentation">
           <p className="text-cyan-300">Get to know me better</p> 
          </Sidebar.Item>
